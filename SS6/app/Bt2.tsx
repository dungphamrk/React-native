...
const INITIAL_SUBJECTS: Subject[] = [
  { id: "1", name: "Mathematics", createdAt: new Date() },
  { id: "2", name: "Physics", createdAt: new Date() },
  { id: "3", name: "Chemistry", createdAt: new Date() },
  { id: "4", name: "Literature", createdAt: new Date() },
  { id: "5", name: "History", createdAt: new Date() },
];
